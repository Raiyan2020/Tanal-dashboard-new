...
export default function ClientsClient({
  ...
  initialPagination: PaginatedItems<Client>['pagination'] | null;
}) {
  ...
  const [pagination, setPagination] = useState<PaginatedItems<Client>['pagination'] | null>(initialPagination);
  ...
  const fetchClients = useCallback(async () => {
    ...
    try {
      ...
      toast.error((err as Error).message || t('unexpectedError'));
    } finally {
