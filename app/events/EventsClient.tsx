...
export default function EventsClient({
  ...
  initialPagination: PaginatedItems<ApiEvent>['pagination'] | null;
}) {
  const { t, dir } = useLanguage();
  ...
  // ── list state ──
  const [events, setEvents] = useState<AppEvent[]>(initialData ?? []);
  const [pagination, setPagination] = useState<PaginatedItems<ApiEvent>['pagination'] | null>(initialPagination);
