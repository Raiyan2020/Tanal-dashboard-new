                  ...
                  <FormItem className="space-y-1.5">
                    ...
                    <FormControl>
                      <input
                        type="time"
                        {...field}
                        className="w-full bg-white/50 border border-secondary/20 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/50 transition-all text-secondary h-[46px] sm:h-[50px]"
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
